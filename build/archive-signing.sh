...
GETH_ARCHIVE_NAME="go-sintrop-${BUILD_OS_NAME}-$(git describe --abbrev=0 --tags)"
ALLTOOLS_ARCHIVE_NAME="go-sintrop-alltools-${BUILD_OS_NAME}-$(git describe --abbrev=0 --tags)"
